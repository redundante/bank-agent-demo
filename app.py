...
st.set_page_config(page_title="Agentic Credit Demo", page_icon="💳")
...
if prompt := st.chat_input("Ex: Book a flight to London for $1200"):
    ...
    with st.chat_message("assistant"):
        ...
        message_placeholder.markdown("🔄 *Consulting Bank Risk Engine...*")
        ...
        if decision["approved"]:
            response_text = f"""
✅ **Transaction Approved** by [Your Bank]
...
"""
            ...
            response_text = f"⚠️ **Transaction Declined**. This exceeds your adjusted limit for {decision['asset_class']} items."
